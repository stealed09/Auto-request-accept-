            ...
            try:
                ...
                if not entity:
                    try:
                        ...
                        err_detail = f"Chat {cid} nahi mila — userbot us chat mein hai?"
                        failed += 1
                        continue
            ...
            try:
                ...
                if not entity:
                    ...
                    try:
                        ...
                        err_detail = f"Entity not found for {cid} — bot/userbot us chat mein admin hai?"
                        failed += 1
                        continue
                    offset_date = None
                    offset_user = None
